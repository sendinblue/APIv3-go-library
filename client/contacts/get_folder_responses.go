...
func (o *GetFolderOK) GetPayload() *models.GetFolder {
	return o.Payload
}
...
func (o *GetFolderBadRequest) GetPayload() *models.ErrorModel {
	return o.Payload
}
...
func (o *GetFolderNotFound) GetPayload() *models.ErrorModel {
	return o.Payload
}
