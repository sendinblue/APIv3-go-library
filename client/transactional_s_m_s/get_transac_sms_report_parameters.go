...
func (o *GetTransacSmsReportParams) WithEndDate(endDate *string) *GetTransacSmsReportParams {
	o.SetEndDate(endDate)
	return o
}

// SetEndDate adds the endDate to the get transac sms report params
func (o *GetTransacSmsReportParams) SetEndDate(endDate *string) {
	o.EndDate = endDate
}

// WithStartDate adds the startDate to the get transac sms report params
func (o *GetTransacSmsReportParams) WithStartDate(startDate *string) *GetTransacSmsReportParams {
	o.SetStartDate(startDate)
	return o
}

// SetStartDate adds the startDate to the get transac sms report params
func (o *GetTransacSmsReportParams) SetStartDate(startDate *string) {
