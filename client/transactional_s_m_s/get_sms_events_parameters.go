...
func (o *GetSmsEventsParams) WithEndDate(endDate *string) *GetSmsEventsParams {
	o.SetEndDate(endDate)
	return o
}

// SetEndDate adds the endDate to the get sms events params
func (o *GetSmsEventsParams) SetEndDate(endDate *string) {
	o.EndDate = endDate
}
...
func (o *GetSmsEventsParams) WithStartDate(startDate *string) *GetSmsEventsParams {
	o.SetStartDate(startDate)
	return o
}

// SetStartDate adds the startDate to the get sms events params
func (o *GetSmsEventsParams) SetStartDate(startDate *string) {
