 ...
 * @param optional nil or *TransactionalSMSApiGetSmsEventsOpts - Optional Parameters:
...
type TransactionalSMSApiGetSmsEventsOpts struct {
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *TransactionalSMSApiGetTransacAggregatedSmsReportOpts - Optional Parameters:
     * @param "StartDate" (optional.String) -  Mandatory if endDate is used. Starting date (YYYY-MM-DD) of the report
     * @param "EndDate" (optional.String) -  Mandatory if startDate is used. Ending date (YYYY-MM-DD) of the report
     * @param "Days" (optional.Int64) -  Number of days in the past including today (positive integer). Not compatible with startDate and endDate
...
type TransactionalSMSApiGetTransacAggregatedSmsReportOpts struct {
    StartDate optional.String
    EndDate optional.String
    Days optional.Int64
    Tag optional.String
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *TransactionalSMSApiGetTransacSmsReportOpts - Optional Parameters:
     * @param "StartDate" (optional.String) -  Mandatory if endDate is used. Starting date (YYYY-MM-DD) of the report
     * @param "EndDate" (optional.String) -  Mandatory if startDate is used. Ending date (YYYY-MM-DD) of the report
     * @param "Days" (optional.Int64) -  Number of days in the past including today (positive integer). Not compatible with &#x27;startDate&#x27; and &#x27;endDate&#x27;
     * @param "Tag" (optional.String) -  Filter on a tag
...
type TransactionalSMSApiGetTransacSmsReportOpts struct {
    StartDate optional.String
    EndDate optional.String
    Days optional.Int64
    Tag optional.String
