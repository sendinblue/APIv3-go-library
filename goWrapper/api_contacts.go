 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param identifier Email (urlencoded) OR ID of the contact
 * @param optional nil or *ContactsApiGetContactStatsOpts - Optional Parameters:
...
type ContactsApiGetContactStatsOpts struct {
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ContactsApiGetContactsOpts - Optional Parameters:
...
type ContactsApiGetContactsOpts struct {
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param listId Id of the list
 * @param optional nil or *ContactsApiGetContactsFromListOpts - Optional Parameters:
     * @param "ModifiedSince" (optional.String) -  Filter (urlencoded) the contacts modified after a given UTC date-time (YYYY-MM-DDTHH:mm:ss.SSSZ). Prefer to pass your timezone in date-time format for accurate result.
     * @param "Limit" (optional.Int64) -  Number of documents per page
     * @param "Offset" (optional.Int64) -  Index of the first document of the page
     * @param "Sort" (optional.String) -  Sort the results in the ascending/descending order of record creation. Default order is **descending** if &#x60;sort&#x60; is not passed
...
type ContactsApiGetContactsFromListOpts struct {
	ModifiedSince optional.String
	Limit         optional.Int64
	Offset        optional.Int64
	Sort          optional.String
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param folderId Id of the folder
 * @param optional nil or *ContactsApiGetFolderListsOpts - Optional Parameters:
     * @param "Limit" (optional.Int64) -  Number of documents per page
     * @param "Offset" (optional.Int64) -  Index of the first document of the page
     * @param "Sort" (optional.String) -  Sort the results in the ascending/descending order of record creation. Default order is **descending** if &#x60;sort&#x60; is not passed
...
type ContactsApiGetFolderListsOpts struct {
	Limit  optional.Int64
	Offset optional.Int64
	Sort   optional.String
}
 ...
 * @param optional nil or *ContactsApiGetFoldersOpts - Optional Parameters:
     * @param "Sort" (optional.String) -  Sort the results in the ascending/descending order of record creation. Default order is **descending** if &#x60;sort&#x60; is not passed
@return GetFolders
*/

type ContactsApiGetFoldersOpts struct {
	Sort optional.String
}
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ContactsApiGetListsOpts - Optional Parameters:
     * @param "Limit" (optional.Int64) -  Number of documents per page
     * @param "Offset" (optional.Int64) -  Index of the first document of the page
     * @param "Sort" (optional.String) -  Sort the results in the ascending/descending order of record creation. Default order is **descending** if &#x60;sort&#x60; is not passed
@return GetLists
...
type ContactsApiGetListsOpts struct {
	Limit  optional.Int64
	Offset optional.Int64
	Sort   optional.String
}
