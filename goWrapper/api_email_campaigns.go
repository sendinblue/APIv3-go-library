...
func (a *EmailCampaignsApiService) CreateEmailCampaign(ctx context.Context, body CreateEmailCampaign) (CreateModel, *http.Response, error) {
	...
	localVarHeaderParams["api-key"] = "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"
	...
	//fmt.Println("====actual resp:", localVarHttpResponse)
	if err != nil || localVarHttpResponse == nil {
		return localVarReturnValue, localVarHttpResponse, err
	}

	localVarBody, err := ioutil.ReadAll(localVarHttpResponse.Body)
	fmt.Println("=====Resp body=====", string(localVarBody), err)
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param campaignId Id of the campaign
 * @param optional nil or *EmailCampaignsApiEmailExportRecipientsOpts - Optional Parameters:
     * @param "Body" (optional.Interface of EmailExportRecipients) -  Values to send for a recipient export request
@return CreatedProcessId
*/

type EmailCampaignsApiEmailExportRecipientsOpts struct {
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *EmailCampaignsApiGetEmailCampaignsOpts - Optional Parameters:
...
type EmailCampaignsApiGetEmailCampaignsOpts struct {
...
func (a *EmailCampaignsApiService) GetEmailCampaigns(ctx context.Context, localVarOptionals *EmailCampaignsApiGetEmailCampaignsOpts) (GetEmailCampaigns, *http.Response, error) {
	...
	// to determine the Accept header
	localVarHttpHeaderAccepts := []string{"application/json", "applications/json"}
