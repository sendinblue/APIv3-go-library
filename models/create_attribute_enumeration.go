...
// CreateAttributeEnumeration Values that the attribute can take. Use only if the attribute's category is category
// swagger:model createAttributeEnumeration
