...
func (m *GetContactCampaignStatsHardBouncesItems) validateCampaignID(formats strfmt.Registry) error {
...
func (m *GetContactCampaignStatsHardBouncesItems) validateEventTime(formats strfmt.Registry) error {
...
func (m *GetContactCampaignStatsHardBouncesItems) UnmarshalBinary(b []byte) error {
	var res GetContactCampaignStatsHardBouncesItems
